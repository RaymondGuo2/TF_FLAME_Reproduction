...
def run_corresponding_mesh_fitting(args):
    ...
    out_mesh_fname = args.out_mesh_fname # will be in .ply format
    out_mesh_fname_obj = out_mesh_fname.replace('.ply', '.obj')
    ...
    show_fitting = args.show_fitting
    # show_fitting = True
    ...
    ply_mesh = trimesh.load(out_mesh_fname)
    ply_mesh.export(out_mesh_fname_obj)
    print(f"Converted {out_mesh_fname} to .OBJ file")


def parse_arguments():
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_fname', type=str)
    parser.add_argument('--target_mesh_path', type=str)
    parser.add_argument('--out_mesh_fname', type=str)
    parser.add_argument('--show_fitting', type=bool, default='False')
    return parser.parse_args()


if __name__ == '__main__':
    args = parse_arguments()
    run_corresponding_mesh_fitting(args)

# python3 fit_3D_mesh.py --model_fname ./models/male_model.pkl --target_mesh_path ./test_results/imgHQ00039.obj --out_mesh_fname ./test_results/imgHQ00039_fitted.ply --show_fitting True